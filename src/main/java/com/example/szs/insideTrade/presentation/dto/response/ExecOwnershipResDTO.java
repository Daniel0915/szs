...
@NoArgsConstructor
@AllArgsConstructor
public class ExecOwnershipResDTO {
    ...
    public static String getMessage(String corpName, List<ExecOwnershipResDTO> execOwnershipResDTOList) {
        StringBuilder messageBuilder = new StringBuilder();
        messageBuilder.append("[").append(corpName).append("]").append("\n");
        for (ExecOwnershipResDTO dto : execOwnershipResDTOList) {
