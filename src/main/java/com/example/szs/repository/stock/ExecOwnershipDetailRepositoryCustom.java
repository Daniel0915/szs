...
//        }
//
//        List<ExecOwnershipDetail> insertEntityList = new ArrayList<>();
//
//        for (ExecOwnershipDetailDTO dto : insertDTOList) {
//            Optional<ExecOwnershipDetail.ExecOwnershipDetailEntityBuilder> optional = Param.getSaveEntityToBuilder(dto, new ExecOwnershipDetail(), new ExecOwnershipDetail().toBuilder());
...
//                                                  .collect(Collectors.toList());
//
//        Map<Long, ExecOwnershipDetail> findUpdateEntityMap = new HashMap<>();
//
...
//                                                   .fetch()
//                                                   .stream()
//                                                   .collect(Collectors.toMap(ExecOwnershipDetail::getSeq, Function.identity(), (oldValue, newValue) -> newValue)));
//
//        }
//
//        List<ExecOwnershipDetail> updateEntityList = new ArrayList<>();
//
//        for (ExecOwnershipDetailDTO dto : updateDTOList) {
//            ExecOwnershipDetail findUpdateEntity = findUpdateEntityMap.getOrDefault(dto.getSeq(), null);
//
//            if (findUpdateEntity == null) {
//                continue;
//            }
//
//            Optional<ExecOwnershipDetail.ExecOwnershipDetailEntityBuilder> optional = Param.getSaveEntityToBuilder(dto, findUpdateEntity, findUpdateEntity.toBuilder());
