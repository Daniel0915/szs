...
public class Param {
    public static <D, E> Optional<E> getSaveEntity(D dto, E entity) throws IllegalAccessException, NoSuchFieldException, NoSuchMethodException, InvocationTargetException {
